...
public class Constants {
	...
	// The constant value of gravity, scaled based on the game's scale

	public static final int ANI_SPEED = 25;
	// The speed of animation playback

	public static class Dialogue {
		// Constants for dialogue types
		public static final int QUESTION = 0;
		public static final int EXCLAMATION = 1;

		public static final int DIALOGUE_WIDTH = (int) (14 * Game.SCALE);
		// The width of the dialogue box, scaled based on the game's scale

		public static final int DIALOGUE_HEIGHT = (int) (12 * Game.SCALE);
		// The height of the dialogue box, scaled based on the game's scale

		public static int GetSpriteAmount(int type) {
			// Get the number of sprites based on the dialogue type
			switch (type) {
	...
	public static class Projectiles {
		...
		// The scaled width of the cannonball projectile

		public static final int CANNON_BALL_HEIGHT = (int) (Game.SCALE * CANNON_BALL_DEFAULT_HEIGHT);
		// The scaled height of the cannonball projectile

		public static final float SPEED = 0.75f * Game.SCALE;
		// The speed of the projectiles, scaled based on the game's scale
	}
